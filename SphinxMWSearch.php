...
class SphinxMWSearch extends SearchDatabase {
	...
	protected function doSearchTitleInDB( $term ) {
		$this->searchClause = static::getSearchClause( $term );
	 ...
	 */
	protected static function getSearchClause( $term ) {
	...
	protected function completionSearchBackend( $search ) {
		...
		$searchEngine->searchClause = self::getSearchClause( $search );

		// use own term and clause
		$resultSet = $searchEngine->searchText( $search );
	...
	public function searchText( $term ) {
		...
		wfDebug( "SphinxMWSearch::searchText: running for '{$term}', clause: '{$this->searchClause}'" );
		...
		if ( $this->sphinxClient ) {
			...
			$clause = str_replace( array_keys( $placeholders ), $placeholders, $this->searchClause );
